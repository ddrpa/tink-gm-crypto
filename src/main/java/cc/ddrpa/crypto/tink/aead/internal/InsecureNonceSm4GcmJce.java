...
public final class InsecureNonceSm4GcmJce {
    ...
    public static final int TAG_SIZE_IN_BYTES = Sm4GcmJceUtil.TAG_SIZE_IN_BYTES;
    ...
    public byte[] encrypt(
        ...
        AlgorithmParameterSpec params = Sm4GcmJceUtil.getParams(iv);
        Cipher localCipher = Sm4GcmJceUtil.getThreadLocalCipher();
