 ...
 */
@Immutable
public final class Sm2EncryptionPublicKey extends HybridPublicKey {

    private final Sm2EncryptionParameters parameters;
    ...
    @Override
    public Sm2EncryptionParameters getParameters() {
        return parameters;
    }
    ...
    public boolean equalsKey(Key o) {
        if (!(o instanceof Sm2EncryptionPublicKey)) {
            return false;
        }
    ...
    /**
     * Builder for Sm2EncryptionPublicKey.
     */
    public static class Builder {

        @Nullable
        private Sm2EncryptionParameters parameters = null;
        @Nullable
         ...
         */
        @CanIgnoreReturnValue
        public Sm2EncryptionPublicKey.Builder setPublicKey(Bytes publicKey) {
            this.publicKey = publicKey;
            return this;
        }

        @CanIgnoreReturnValue
        public Sm2EncryptionPublicKey.Builder setIdRequirement(@Nullable Integer idRequirement) {
            this.idRequirement = idRequirement;
            return this;
        }

        private Bytes getOutputPrefix() {
            if (parameters.getVariant() == Sm2EncryptionParameters.Variant.NO_PREFIX) {
