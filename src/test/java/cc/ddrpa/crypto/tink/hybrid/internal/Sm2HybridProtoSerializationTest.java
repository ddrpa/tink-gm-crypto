...
/**
 * Test for Sm2HybridProtoSerialization.
 */
@SuppressWarnings("UnnecessarilyFullyQualified") // Fully specifying proto types is more readable
class Sm2HybridProtoSerializationTest {
    ...
    static void setUp() throws Exception {
        Sm2HybridProtoSerialization.register(registry);
    }
    ...
    private static Sm2HybridParameters parameters(
        Sm2HybridParameters.Variant variant) throws GeneralSecurityException {
        return Sm2HybridParameters.builder().setVariant(variant).build();
    }

    private static Sm2HybridPublicKey createPublicKey(
        Sm2HybridParameters.Variant variant, Integer idRequirement)
    ...
    private static Sm2HybridPrivateKey createPrivateKey(
        Sm2HybridParameters.Variant variant, Integer idRequirement)
        throws GeneralSecurityException {
    ...
    private static Stream<ProtoParametersSerialization> invalidParametersSerializations() {
        return Stream.of(
            ...
            createParametersSerialization(PRIVATE_TYPE_URL, OutputPrefixType.UNKNOWN_PREFIX,
                cc.ddrpa.crypto.tink.proto.Sm2HybridKeyFormat.newBuilder().build()),
            ...
            createParametersSerialization(PRIVATE_TYPE_URL, OutputPrefixType.RAW,
                cc.ddrpa.crypto.tink.proto.Sm2HybridKeyFormat.newBuilder().setVersion(1)
                    .build()));
    }
        ...
        try {
            return Stream.of(
                ...
                ProtoKeySerialization.create(PUBLIC_TYPE_URL,
                    cc.ddrpa.crypto.tink.proto.Sm2HybridPublicKey.newBuilder().setVersion(1)
                        .setX(X).setY(Y).build().toByteString(),
                    KeyMaterialType.ASYMMETRIC_PUBLIC, OutputPrefixType.TINK, 1479),
                // Unknown prefix
                ProtoKeySerialization.create(PUBLIC_TYPE_URL,
                    cc.ddrpa.crypto.tink.proto.Sm2HybridPublicKey.newBuilder().setVersion(0)
                        .setX(X).setY(Y).build().toByteString(),
        ...
        try {
            return Stream.of(
                ...
                ProtoKeySerialization.create(PRIVATE_TYPE_URL,
                    cc.ddrpa.crypto.tink.proto.Sm2HybridPrivateKey.newBuilder().setVersion(1)
                        .setPublicKey(
                            cc.ddrpa.crypto.tink.proto.Sm2HybridPublicKey.newBuilder()
                ...
                ProtoKeySerialization.create(PRIVATE_TYPE_URL,
                    cc.ddrpa.crypto.tink.proto.Sm2HybridPrivateKey.newBuilder().setVersion(0)
                        .setPublicKey(
                            cc.ddrpa.crypto.tink.proto.Sm2HybridPublicKey.newBuilder()
    ...
    void registerTwice() throws Exception {
        ...
        Sm2HybridProtoSerialization.register(newRegistry);
        Sm2HybridProtoSerialization.register(newRegistry);
    }
    ...
    void serializeParseParameters_noPrefix() throws Exception {
        Sm2HybridParameters parameters =
            parameters(Sm2HybridParameters.Variant.NO_PREFIX);
        ...
        assertEqualWhenValueParsed(
            cc.ddrpa.crypto.tink.proto.Sm2HybridKeyFormat.parser(), serialized, serialization);
    ...
    void serializeParseParameters_tink() throws Exception {
        Sm2HybridParameters parameters =
            parameters(Sm2HybridParameters.Variant.TINK);
    ...
    void serializeParsePublicKey_noPrefix() throws Exception {
        Sm2HybridPublicKey key =
            createPublicKey(Sm2HybridParameters.Variant.NO_PREFIX, null);
        ...
        assertEqualWhenValueParsed(
            cc.ddrpa.crypto.tink.proto.Sm2HybridPublicKey.parser(), serialized, serialization);
    ...
    void serializeParsePublicKey_tink() throws Exception {
        Sm2HybridPublicKey key = createPublicKey(Sm2HybridParameters.Variant.TINK, 123);
    ...
    void serializeParsePrivateKey_noPrefix() throws Exception {
        Sm2HybridPrivateKey key =
            createPrivateKey(Sm2HybridParameters.Variant.NO_PREFIX, null);

        cc.ddrpa.crypto.tink.proto.Sm2HybridPrivateKey protoPrivateKey =
        ...
        assertEqualWhenValueParsed(
            cc.ddrpa.crypto.tink.proto.Sm2HybridPrivateKey.parser(), serialized, serialization);
    ...
    void serializeParsePrivateKey_tink() throws Exception {
        Sm2HybridPrivateKey key =
            createPrivateKey(Sm2HybridParameters.Variant.TINK, 123);
