...
/**
 * Test for Sm2EncryptionProtoSerialization.
 */
@SuppressWarnings("UnnecessarilyFullyQualified") // Fully specifying proto types is more readable
class Sm2EncryptionProtoSerializationTest {
    ...
    static void setUp() throws Exception {
        Sm2EncryptionProtoSerialization.register(registry);
    }
    ...
    private static Sm2EncryptionParameters parameters(
    ...
    private static Sm2EncryptionPublicKey createPublicKey(
        Sm2EncryptionParameters.Variant variant, Integer idRequirement)
    ...
    private static Sm2EncryptionPrivateKey createPrivateKey(
        Sm2EncryptionParameters.Variant variant, Integer idRequirement)
        throws GeneralSecurityException {
    ...
    private static Stream<ProtoParametersSerialization> invalidParametersSerializations() {
        return Stream.of(
            ...
            createParametersSerialization(PRIVATE_TYPE_URL, OutputPrefixType.UNKNOWN_PREFIX,
                cc.ddrpa.crypto.tink.proto.Sm2EncryptionKeyFormat.newBuilder().build()),
            ...
            createParametersSerialization(PRIVATE_TYPE_URL, OutputPrefixType.RAW,
                cc.ddrpa.crypto.tink.proto.Sm2EncryptionKeyFormat.newBuilder().setVersion(1)
                    .build()));
    }
        ...
        try {
            return Stream.of(
                ...
                ProtoKeySerialization.create(PUBLIC_TYPE_URL,
                    cc.ddrpa.crypto.tink.proto.Sm2EncryptionPublicKey.newBuilder().setVersion(1)
                        .setX(X).setY(Y).build().toByteString(),
                    KeyMaterialType.ASYMMETRIC_PUBLIC, OutputPrefixType.TINK, 1479),
                // Unknown prefix
                ProtoKeySerialization.create(PUBLIC_TYPE_URL,
                    cc.ddrpa.crypto.tink.proto.Sm2EncryptionPublicKey.newBuilder().setVersion(0)
                        .setX(X).setY(Y).build().toByteString(),
        ...
        try {
            return Stream.of(
                ...
                ProtoKeySerialization.create(PRIVATE_TYPE_URL,
                    cc.ddrpa.crypto.tink.proto.Sm2EncryptionPrivateKey.newBuilder().setVersion(1)
                        .setPublicKey(
                            cc.ddrpa.crypto.tink.proto.Sm2EncryptionPublicKey.newBuilder()
                ...
                ProtoKeySerialization.create(PRIVATE_TYPE_URL,
                    cc.ddrpa.crypto.tink.proto.Sm2EncryptionPrivateKey.newBuilder().setVersion(0)
                        .setPublicKey(
                            cc.ddrpa.crypto.tink.proto.Sm2EncryptionPublicKey.newBuilder()
    ...
    void registerTwice() throws Exception {
        ...
        Sm2EncryptionProtoSerialization.register(newRegistry);
        Sm2EncryptionProtoSerialization.register(newRegistry);
    }
    ...
    void serializeParseParameters_noPrefix() throws Exception {
        Sm2EncryptionParameters parameters =
            parameters(Sm2EncryptionParameters.Variant.NO_PREFIX);
        ...
        assertEqualWhenValueParsed(
            cc.ddrpa.crypto.tink.proto.Sm2EncryptionKeyFormat.parser(), serialized, serialization);
    ...
    void serializeParseParameters_tink() throws Exception {
        Sm2EncryptionParameters parameters =
            parameters(Sm2EncryptionParameters.Variant.TINK);
    ...
    void serializeParsePublicKey_noPrefix() throws Exception {
        Sm2EncryptionPublicKey key =
            createPublicKey(Sm2EncryptionParameters.Variant.NO_PREFIX, null);
        ...
        assertEqualWhenValueParsed(
            cc.ddrpa.crypto.tink.proto.Sm2EncryptionPublicKey.parser(), serialized, serialization);
    ...
    void serializeParsePublicKey_tink() throws Exception {
        Sm2EncryptionPublicKey key = createPublicKey(Sm2EncryptionParameters.Variant.TINK, 123);
    ...
    void serializeParsePrivateKey_noPrefix() throws Exception {
        Sm2EncryptionPrivateKey key =
            createPrivateKey(Sm2EncryptionParameters.Variant.NO_PREFIX, null);

        cc.ddrpa.crypto.tink.proto.Sm2EncryptionPrivateKey protoPrivateKey =
        ...
        assertEqualWhenValueParsed(
            cc.ddrpa.crypto.tink.proto.Sm2EncryptionPrivateKey.parser(), serialized, serialization);
    ...
    void serializeParsePrivateKey_tink() throws Exception {
        Sm2EncryptionPrivateKey key =
            createPrivateKey(Sm2EncryptionParameters.Variant.TINK, 123);
    ...
    void testParsePrivateKey_noAccess_throws() throws Exception {
        ...
        assertThrows(GeneralSecurityException.class,
            () -> registry.parseKey(serialization, null));
    }
