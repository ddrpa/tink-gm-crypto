...
public final class Sm2HybridKeyTest {
    ...
    private static Sm2HybridParameters parameters(Sm2HybridParameters.Variant variant)
    ...
    private static Sm2HybridPublicKey buildPublicKey(
        Sm2HybridParameters parameters, byte[] publicKey, @Nullable Integer idRequirement)
        throws GeneralSecurityException {
    ...
    private static Sm2HybridPrivateKey buildPrivateKey(
        Sm2HybridPublicKey publicKey, byte[] privateValue) throws GeneralSecurityException {
    ...
    public void buildNoPrefixPublicKeyAndGetProperties() throws Exception {
        ...
        Sm2HybridParameters parameters = parameters(NO_PREFIX);
        Sm2HybridPublicKey key = buildPublicKey(parameters, material.publicKey, null);
    ...
    public void buildTinkPublicKeyAndGetProperties() throws Exception {
        KeyMaterial material = generateKeyMaterial();
        Sm2HybridParameters parameters = parameters(TINK);
        Sm2HybridPublicKey key = buildPublicKey(parameters, material.publicKey, 0x66AABBCC);
        assertThat(key.getParameters()).isEqualTo(parameters);
        assertThat(key.getPublicKey().toByteArray()).isEqualTo(material.publicKey);
    ...
    public void testPublicKeyEqualities() throws Exception {
        ...
        Sm2HybridParameters noPrefixParams = parameters(NO_PREFIX);
        Sm2HybridParameters tinkParams = parameters(TINK);
    ...
    public void emptyBuild_fails() {
        assertThrows(GeneralSecurityException.class,
            () -> Sm2HybridPublicKey.builder().build());
    }
    ...
    public void buildNoPrefixPrivateKeyAndGetProperties() throws Exception {
        KeyMaterial material = generateKeyMaterial();
        Sm2HybridParameters parameters = parameters(NO_PREFIX);
        Sm2HybridPublicKey publicKey = buildPublicKey(parameters, material.publicKey, null);
        Sm2HybridPrivateKey key = buildPrivateKey(publicKey, material.privateValue);
        assertThat(key.getParameters()).isEqualTo(parameters);
    ...
    public void buildTinkPrivateKeyAndGetProperties() throws Exception {
        KeyMaterial material = generateKeyMaterial();
        Sm2HybridParameters parameters = parameters(TINK);
        Sm2HybridPublicKey publicKey = buildPublicKey(parameters, material.publicKey, 123);
        Sm2HybridPrivateKey key = buildPrivateKey(publicKey, material.privateValue);
        assertThat(key.getParameters()).isEqualTo(parameters);
    ...
    public void testPrivateKeyEqualities() throws Exception {
        ...
        Sm2HybridParameters noPrefixParams = parameters(NO_PREFIX);
        Sm2HybridParameters tinkParams = parameters(TINK);
        Sm2HybridPublicKey publicKey1 =
            buildPublicKey(noPrefixParams, material1.publicKey, null);
        Sm2HybridPublicKey publicKey2 =
            buildPublicKey(noPrefixParams, material2.publicKey, null);
        Sm2HybridPublicKey tinkPublicKey1 =
            buildPublicKey(tinkParams, material1.publicKey, 1);
    ...
    public void buildWithoutPrivateValue_fails() throws Exception {
        KeyMaterial material = generateKeyMaterial();
        Sm2HybridPublicKey publicKey = buildPublicKey(parameters(NO_PREFIX),
            material.publicKey, null);
        assertThrows(GeneralSecurityException.class,
            () -> Sm2HybridPrivateKey.builder().setPublicKey(publicKey).build());
    }
    ...
    public void testDifferentKeyTypesEquality_fails() throws Exception {
        ...
        Sm2HybridPublicKey publicKey = buildPublicKey(parameters(NO_PREFIX),
            material.publicKey, null);
        Sm2HybridPrivateKey privateKey = buildPrivateKey(publicKey, material.privateValue);
